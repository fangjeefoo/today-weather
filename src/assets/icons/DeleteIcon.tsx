const DeleteIcon: React.FC = () => {
  return (
      <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg"
        ...
        <rect x="0.717896" width="16" height="16" fill="url(#pattern0_2_339)" fill-opacity="0.5"/>
        <defs>
          <pattern id="pattern0_2_339" patternContentUnits="objectBoundingBox" width="1" height="1">
            <use xlinkHref="#image0_2_339" transform="scale(0.0104167)"/>
          </pattern>
          <image id="image0_2_339" width="96" height="96"
